...
export default function CreateProductPage() {
  ...
  return (
    <div className="container mt-5 p-4 shadow-lg rounded bg-light" style={{ maxWidth: "700px" }}>
      <h2 className="mb-4 text-center text-success fw-bold">Cadastrar Novo Produto</h2>
      <form onSubmit={handleSubmit} noValidate>
        ...
        <button type="submit" id="saveProd" className="btn btn-success w-100 mt-4">Salvar Produto</button>
      ...
      <div className="text-center mt-4">
        <button className="btn btn-secondary" id="returnButton" onClick={() => navigate("/main")}>Voltar ao Menu</button>
      </div>
    </div>
  );
}
